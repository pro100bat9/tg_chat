...
public class LinkRecord extends UpdatableRecordImpl<LinkRecord> implements Record4<Long, String, OffsetDateTime, OffsetDateTime> {
    ...
    public LinkRecord(@NotNull Long id, @NotNull String url, @NotNull OffsetDateTime lastCheckTime, @NotNull OffsetDateTime updatedAt) {
        super(Link.LINK);
     ...
     * Create a detached, initialised LinkRecord
     */
    public LinkRecord(com.example.scrapper.domain.jooq.tables.pojos.Link value) {
        super(Link.LINK);
