...
import com.example.scrapper.domain.jooq.Indexes;
import com.example.scrapper.domain.jooq.Keys;
import com.example.scrapper.domain.jooq.Public;
import com.example.scrapper.domain.jooq.tables.records.LinkRecord;
...
public class Link extends TableImpl<LinkRecord> {
     ...
     */
    public final TableField<LinkRecord, Long> ID = createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("nextval('link_id_sequence'::regclass)", SQLDataType.BIGINT)), this, "");
     ...
     */
    public final TableField<LinkRecord, OffsetDateTime> LAST_CHECK_TIME = createField(DSL.name("last_check_time"), SQLDataType.TIMESTAMPWITHTIMEZONE(6).nullable(false).defaultValue(DSL.field("now()", SQLDataType.TIMESTAMPWITHTIMEZONE)), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.asList(Indexes.INDEX_LINK_URL);
    }
